...
exports.signup = async (req, res) => {
  ...
  try {
    ...
    const shouldBeAdmin = isAdmin === true || !adminExists;

    console.log("=== SIGNUP ATTEMPT ===");
    console.log("Username:", username);
    console.log("isAdmin from request:", isAdmin);
    console.log("adminExists:", !!adminExists);
    console.log("shouldBeAdmin:", shouldBeAdmin);
    ...
    req.session.save((err) => {
      if (err) {
        ...
        return res
          .status(500)
          .json({ message: "Signup successful but login failed" });
      }
