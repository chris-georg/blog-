...
exports.createPost = async (req, res) => {
    ...
    if (!title || !excerpt || !content) {
        ...
        return res.status(400).json({ 
            message: "Please fill in all the required fields: title, excerpt, content" 
        });
    }
...
exports.deletePost = async (req, res) => {
    ...
    try {
        ...
        console.log('Post found - Created by:', post.createdBy);
        console.log('Current user:', req.session.userId);
        
        // Optional: Check if user owns the post (only allow creator to delete)
